...
#   - Nối (Join) có nghĩa kéo nội dung của 2 hay nhiều mảng lại với nhau tạo thành 1 mảng riêng biệt.
#   - Trong SQL, ta thực hiện việc nối nhiều bảng lại với nhau dựa theo khóa. Trong NumPy, ta nối nhiều mảng lại với nhau dựa theo trục của mảng (axis)
...
arr = np.concatenate((arr1, arr2))  # Nối 2 mảng 1 chiều
print(arr)

arr1 = np.array([[1, 2], [3, 4]])
arr2 = np.array([[5, 6], [7, 8]])

# Nối 2 mảng 2 chiều dựa theo trục hoành
...
#   - Ta có thể nối 2 mảng 1 chiều dọc theo trục axis thứ 2, kết quả cũng sẽ tương tự với stack
#   - Ta truyền vào các đối số là các mảng mà ta muốn nối vào trong phương thức stack(), cùng với đối số axis. Nếu axis không được truyền vào, phương thức sẽ mặc định axis = 0
